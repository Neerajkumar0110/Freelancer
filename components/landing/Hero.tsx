  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="flex -space-x-3 group-hover:-space-x-1 transition-all duration-500">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="relative w-8 h-8 rounded-full border-2 border-[#020617] overflow-hidden"
              >
                <Image
        ...
        >
          Skip the recruitment cycle. Instantly deploy top-tier developers,
          designers, and AI architects through our{" "}
          <span className="text-white">AI-matching neural engine.</span>
        </motion.p>
